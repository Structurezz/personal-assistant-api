...
const log = (0, debug_1.default)('twilio-runtime-handler:dev:runtime');
function getAssets() {
    const { assets } = (0, route_cache_1.getCachedResources)();
    if (assets.length === 0) {
        return {};
    }
    const result = {};
...
function getFunctions() {
    const { functions } = (0, route_cache_1.getCachedResources)();
...
function create({ env, logger, baseDir, }) {
    function getSync(options) {
        ...
        const client = (0, requireFromProject_1.requireFromProject)(baseDir, 'twilio', true)(env.ACCOUNT_SID, env.AUTH_TOKEN, options);

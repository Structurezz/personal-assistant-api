...
const log = (0, debug_1.default)('twilio-runtime-handler:dev:server');
...
class LocalDevelopmentServer extends events_1.EventEmitter {
    constructor(port = DEFAULT_PORT, config) {
        ...
        this.setRoutes = (routes) => {
            this.routes = routes;
            this.routeMap = (0, route_cache_1.setRoutes)(this.routes);
        };
        this.createServer = () => {
            ...
            if (this.config.logs) {
                app.use((0, request_logger_1.createLogger)(this.logFunction));
            }
            if (this.config.live) {
            ...
            (0, route_1.constructGlobalScope)(this.config);
                ...
                if (routeInfo && routeInfo.type === 'function') {
                    ...
                    try {
                        ...
                        if (this.config.forkProcess) {
                            (0, route_1.functionPathToRoute)(functionPath, this.config)(req, res, next);
                        }
                        else {
                            ...
                            (0, route_1.functionToRoute)(twilioFunction, this.config, functionPath)(req, res, next);
                        }
                    }
                    catch (err) {
